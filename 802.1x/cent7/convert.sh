...
openssl pkcs12 -in out/${1}.test.local.pfx -out out/${1}/${1}.pem -passin pass:${PIS} -passout pass:${POS}
#openssl rsa -des3 -in out/${1}/${1}.pem -out out/${1}/${1}.key -passin pass:${POS} -passout pass:${POS}
openssl rsa -in out/${1}/${1}.pem -out out/${1}/${1}.key -passin pass:${POS} -passout pass:${POS}
